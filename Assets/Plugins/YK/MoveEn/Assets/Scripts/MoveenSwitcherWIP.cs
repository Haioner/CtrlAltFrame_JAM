...
//                animationToRagdoll.enabled = false;
        ...
        public void die() {
            ...
            ragdollRb.linearVelocity = stepperRb.linearVelocity * 1.5f;
        ...
        public bool stepperIsTurnedOn() {
            for (int i = 0; i < cache1.Length; ) return cache1[i].transition == 0;
            for (int i = 0; i < cache2.Length; ) return cache2[i].transition == 0;
            return true;
        }
